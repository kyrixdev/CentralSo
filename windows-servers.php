    ...
    <div class="container mx-auto px-5">
                    <div class="bg-transparant">
                        <nav class="tabs flex flex-col sm:flex-row justify-center">
                            <button data-target="panel-1" class="tab active text-white py-4 px-6 block hover:text-red-800 focus:outline-none border-b-2 font-medium border-red-500">
                                <img class="rounded-full inline-block mr-3" src="img/usa-icon.svg" width="32">North America
                            </button>
                            <button data-target="panel-2" class="tab text-white py-4 px-6 block hover:text-red-500 focus:outline-none">
                                <img class="rounded-full inline-block mr-2" src="img/eun-icon.svg" width="32">Europe
                            </button>
                            <button data-target="panel-3" class="tab text-white py-4 px-6 block hover:text-red-500 focus:outline-none">
                        ...
                        <div class="panel-1 tab-content active py-5">
                            <div class="grid grid-flow-col grid-rows-4 grid-cols-1 lg:grid-rows-1 lg:grid-cols-4 text-center mx-auto p-5">
                                    <div class="col-start-1 lg:col-start-1">
                                        <div class="service-card bg-white rounded-xl mx-auto">
                                            <div class="mx-auto p-4">
                                                <h2 class="text-3xl bold mt-6 text-white"><span style="background-color:#ffa83cc2;">Bronze</span></h2>
                                                <p class="text-center text-gray-300 font-normal mt-4">Basic Hardware for cheap price</p>
                                            </div>
                                            <div class="p-5">
                                                <ul class="text-left">
                                                    <li class="text-white font-normal"><i class="fas fa-microchip red-fa mr-2"></i>CPU: <span class="float-right mr-5">2 Cores</span></li>
                                                    <li class="text-white font-normal"><i class="fas fa-memory red-fa mr-2"></i>RAM: <span class="float-right mr-5">6GB</span></li>
                                                    <li class="text-white font-normal"><i class="fas fa-hdd red-fa mr-2"></i>SSD Disk: <span class="float-right mr-5">60GB</span></li>
                                                    <li class="text-white font-normal"><i class="fas fa-ethernet red-fa mr-2 "></i> Network: <span class="float-right mr-5">Unmetered</span></li>  
                                                </ul>
                                                <h3 class="text-2xl text-center text-gray-200 my-5">$10<span class="text-xl">/mo</span></h3>
                                                <a href="" class="text-bold text-large text-white bg-red-500 rounded-md p-3 mt-5">Deploy Server</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-start-1 lg:col-start-2">
                                        <div class="service-card bg-white rounded-xl mx-auto">
                                            <div class="mx-auto p-4">
                                                <h2 class="text-3xl bold mt-6 text-white"><span style="background-color:#bbbbbb;">Silver</span></h2>
                                                <p class="text-center text-gray-300 font-normal mt-4">Basic Hardware for cheap price</p>
                                            </div>
                                            <div class="p-5">
                                                <ul class="text-left">
                                    ...
                                    <div class="col-start-1 lg:col-start-3">
                                        <div class="service-card bg-white rounded-xl mx-auto">
                                            <div class="mx-auto p-4">
                                                <h2 class="text-3xl bold mt-6 text-white"><span style="background-color: #ffeb3b;color: #585555;">Gold</span></h2>
                                                <p class="text-center text-gray-300 font-normal mt-4 mt-4 mt-4">Basic Hardware for cheap price</p>
                                            </div>
                                            <div class="p-5">
                                                <ul class="text-left">
                                                    <li class="text-white font-normal"><i class="fas fa-microchip red-fa mr-2"></i>CPU: <span class="float-right mr-5">2 Cores</span></li>
                                    ...
                                    <div class="col-start-1 lg:col-start-4">
                                        <div class="service-card bg-white rounded-xl mx-auto">
                                            <div class="mx-auto p-4">
                                                <h2 class="text-3xl bold mt-6 text-white"><span style="background-color:#ff3c3cc2;">Enterprise</span></h2>
                                                <p class="text-center text-gray-300 font-normal mt-4">Basic Hardware for cheap price</p>
                                            </div>
                                            <div class="p-5">
                                                <ul class="text-left">
