...
include('header.php')
?>
<section id="hero-text" class="text-gray-900  body-font" data-aos="fade-up" data-aos-duration="900">
...
<section id="services">
    <div class="container mx-auto">
        <h1 class="title-font sm:text-4xl text-3xl font-medium text-center text-gray-900 ">Services that we provide</h1>
        <h1 class="text-center text-gray-500">Our service is always affordable for everyone.</h1>
                ...
                <div class="col-start-1 lg:col-start-1">
                    <div class="service-card rounded-xl mx-auto">
                        <div class="mx-auto p-5">
                            ...
                            <h2 class="text-xl text-gray-900  bold mt-6">Windows VPS</h2>
                ...
                <div class="col-start-1 lg:col-start-2">
                    <div class="service-card bg-white rounded-xl mx-auto">
                        <div class="mx-auto p-5">
                            ...
                            <h2 class="text-xl text-gray-900  bold mt-6">Linux VPS</h2>
                            <p class="text-center text-gray-400">Starting at 3$/mo </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-start-1 lg:col-start-3">
                    <div class="service-card bg-white rounded-xl mx-auto">
                        <div class="mx-auto p-5">
                            ...
                            <h2 class="text-xl text-gray-900  bold mt-6">Dedicated Servers</h2>
                            <p class="text-center text-gray-400">Starting at 3$/mo </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-start-1 lg:col-start-4">
                    <div class="service-card bg-white rounded-xl mx-auto">
                        <div class="mx-auto p-5">
                            ...
                            <h2 class="text-xl text-gray-900  bold mt-6">Colocation</h2>
...
<section class="features" id="features">
    <div class="container-full mx-auto special-red p-5 pt-8">
        <h2 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white  text-center">
            <i class="fas fa-quote-left text-gray-200  white-quote"></i>  Why choose Central? <i class="fas fa-quote-right text-gray-200  white-quote"></i>
    ...
    <div class="grid grid-flow-col grid-rows-4 grid-cols-1 lg:grid-rows-2 lg:grid-cols-3 lg:gap-3 text-center mx-auto lg:p-5">
        ...
        <div class="feature px-5 col-start-1 lg:col-start-2">
            <div class="bg-transparent text-gray-100  mx-auto p-5 rounded-xl border-2 border-white">
                <i class="fas fa-headset font-bold text-3xl mr-2 text-gray-100 "></i><h3 class="font-bold text-2xl inline-block">Premium Support</h3>
            <div class="text-center font-thin pt-3">
                <p class="text-lg p-2">
                Lorem ipsum dolor sit amet, consectetur adipis elit.
                </p>
...
<div class="container locations mx-auto p-5">
    ...
    <h2 class="text-center text-lg font-thin text-gray-500">Server Hosting Locations</h2>
    <div class="map">
